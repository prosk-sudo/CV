...
\begin{document}
    ...
    \section{Kenntnisse}
        ...
        \begin{onecolentry}
            \textbf{Programmiersprachen:} Python, C, C++, Java, JavaScript, Lua, SQL, HTML/CSS, Lilypond
        \end{onecolentry}

        \vspace{0.13 cm}

        \begin{onecolentry}
            \textbf{Frameworks \& Bibliotheken:} FastAPI, PyTorch, scikit-learn, Hugging Face, LibGDX
        \end{onecolentry}

        \vspace{0.13 cm}

        \begin{onecolentry}
            \textbf{Tools \& Plattformen:} Linux, Bash, Git, GitHub, Docker, uv
        \end{onecolentry}
