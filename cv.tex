...
\begin{document}
    ...
    \begin{header}
        \textbf{\fontsize{24 pt}{24 pt}\selectfont Jeong Jun Ahn}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://seolgi.co.kr/}{\color{black}{\footnotesize\faLink}\hspace*{0.13cm}seolgi.co.kr}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} Python, C, C++, Java, Haskell, SQL
        \end{onecolentry}
